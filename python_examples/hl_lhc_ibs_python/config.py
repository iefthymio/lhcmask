configuration = {
    ...
    'links'                    : {
                                    ...
                                    'optics_toolkit' : 'optics_repository/HLLHCV1.5/toolkit'
                                 },
    # Mode - choose between:
    ...
    # Optics file HLLHCV1.4
    # 'optics_file'              : 'optics_repository/HLLHCV1.4/round/opt_round_150_1500_thin.madx', #15 cm

    'optics_file'              : 'optics_repository/HLLHCV1.5/round/opt_round_150_1500.madx', #15 cm
    # 'optics_file'              : 'optics_repository/HLLHCV1.5/round/opt_round_200_1500_thin.madx', #20 cm


    # other optics files for different beta*
    # 'optics_file'              : 'optics_repository/HLLHCV1.5/ramp/opt_ramp_1000_1500_thin.madx', #1 m
    # 'optics_file'              : 'optics_repository/HLLHCV1.5/ramp/opt_ramp_850_1500_thin.madx', #1 m
    # 'optics_file'              : 'optics_repository/HLLHCV1.5/ramp/opt_ramp_640_1500_thin.madx', #1 m
    ...
    # for the HLLHCV1.5 files the matching to the beta values at IP1/IP5 requires larger tolerances
    ...
    'beambeam_config'      :
        {
            ...
            'sigmaz_m'                 : None,
            'z_crab_twiss'             : 0.075,
            # filling_scheme_json : json file to consider for the bunch bb calculation
            # bunch_to_track : bunch to consider for bb calculation
        },
